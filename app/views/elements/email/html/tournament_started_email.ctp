...
<p>The tournament <?php echo $tournament_name ?> started. Find your first match at:
<a href="http://<?php echo $_SERVER['SERVER_NAME'].'/'.Configure::read('__Caketourney.folder').'caketourney/tournaments/view/'.$tournament_id ?>"><?php echo $tournament_name ?></a> </p>
